...
final class ResponseWebViewCell: UITableViewCell, WKNavigationDelegate, WKUIDelegate {
    ...
    func getHtmlSource(template: Template, data: Data, lang: String, theme: String) -> String {
        ...
        if template == .preview { return self.rawTemplate.replacingOccurrences(of: "#_api-tester-pro-extrapolate-texts", with: html) }
        html = html.replaceAll(pattern: "\n+", with: "\n").replacingOccurrences(of: "&", with: "&amp;")
            .replacingOccurrences(of: "<", with: "&lt;").replacingOccurrences(of: ">", with: "&gt;").replacingOccurrences(of: "\"", with: "&quot;")
            .replacingOccurrences(of: "'", with: "&#039;")
            //.replacingOccurrences(of: "\n", with: "<br>")
        let lang = html.count > 100000 ? "language-plain" : lang
        return (template == .rawview ? self.rawTemplate : self.previewTemplate).replacingOccurrences(of: "#_api-tester-pro-extrapolate-texts", with: html)
            .replacingOccurrences(of: "#_api-tester-pro-extrapolate-language", with: lang).replacingOccurrences(of: "#_api-tester-pro-extrapolate-theme", with: theme)
    }
