...
public struct AESGCM {
    ...
    public init(key: Data, nonce: Data, tag: Data) throws {
        self.key = key
        self.nonce = nonce
        self.tag = tag
    ...
    public init(key: Data, nonce: Data, tag: Data, meta: Data) throws {
        self.key = key
        self.nonce = nonce
        self.tag = tag
        self.symKey = SymmetricKey(data: self.nonce)
    ...
    public func validateKeySize() throws {
    ...
    public func validateNonceSize() throws {
        if nonce.count != 12 {
    ...
    public func encrypt(string: String) throws -> (cipher: Data, tag: Data)? {
...
public struct Hash {
    ...
    public static func md5(txt: String) -> String {
...
public enum AZTLSCipherSuite: Int {
...
public enum AZTLSProtocolVersion: Int {
    case tls10 = 769
    case tls11 = 770
    case tls12 = 771
    case tls13 = 772
