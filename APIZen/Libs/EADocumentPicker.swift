...
final class EADocumentPicker: NSObject {
    ...
    private let photoAccessMessage = "This app does not have access to your photos or videos. To enable access, tap Settings and turn on Photos."
    private let cameraAccessMessage = "This app does not have access to your camera. To enable access, tap Settings and turn on Camera."
